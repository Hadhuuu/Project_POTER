...
<head>
    ...
    <style>
        ...
        #jenisPelanggaranTable tbody tr:hover {
...
<body class="bg-gray-100">
    <div class="flex h-screen px-4 py-4">
        ...
        <div class="flex-1 p-6">
            <h2 class="text-2xl font-semibold text-gray-700 mb-4">Jenis Pelanggaran</h2>

            <!-- Filter dan Tabel Jenis Pelanggaran -->
            <div class="bg-white p-8 rounded-lg shadow-md mb-6">
                <h3 class="text-xl font-semibold mb-4">Data Jenis Pelanggaran</h3>

                <!-- Filter -->
                <div class="mb-4">
                    <label for="tingkatanFilter" class="block text-sm font-semibold text-gray-700">Filter Berdasarkan Tingkatan:</label>
                    <select id="tingkatanFilter" class="mt-1 block w-full p-2 border border-gray-300 rounded-md">
                ...
                <div id="jenisPelanggaranTable">
                    <table class="min-w-full bg-white shadow-md rounded-lg overflow-hidden">
                        ...
                        <tbody id="jenisPelanggaranTbody">
    ...
    <script>
        $(document).ready(function() {
            // Load data jenis pelanggaran saat halaman dimuat
            loadJenisPelanggaran();

            // Filter berdasarkan tingkatan
            $('#tingkatanFilter').change(function() {
                loadJenisPelanggaran();
            });

            function loadJenisPelanggaran() {
                let tingkatan = $('#tingkatanFilter').val();
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $('#jenisPelanggaranTbody').empty();
                        data.forEach(function(item) {
                            $('#jenisPelanggaranTbody').append(`
                                <tr>
